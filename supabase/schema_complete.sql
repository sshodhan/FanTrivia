-- HawkTrivia Complete Database Schema
-- This file contains ALL tables + 51 trivia questions + detailed player data
-- Run this in Supabase SQL Editor for a complete fresh setup
...
-- ============================================
-- 4. GAME DAY ROUNDS TABLE (for live play)
-- ============================================
...
-- ============================================
-- 8. PLAYERS TABLE (Super Bowl Heroes)
-- ============================================
...
-- ============================================
-- 9. GAME SETTINGS TABLE (singleton)
-- ============================================
...
-- ============================================
-- SEED DATA: Super Bowl Heroes (6 players with detailed stats)
-- ============================================
...
-- ============================================
-- SEED DATA: 51 Trivia Questions (8 Categories)
-- ============================================
...
('What year did the Seattle Seahawks win their first Super Bowl?', '2012', '2013', '2014', '2015', 'c', 'easy', 'Super Bowl XLVIII'),
...
-- Category 2: Legion of Boom (6 questions)
INSERT INTO trivia_questions (question_text, option_a, option_b, option_c, option_d, correct_answer, difficulty, category) VALUES
...
-- Category 3: Russell Wilson Era (6 questions)
INSERT INTO trivia_questions (question_text, option_a, option_b, option_c, option_d, correct_answer, difficulty, category) VALUES
...
-- Category 4: Seahawks Legends (6 questions)
INSERT INTO trivia_questions (question_text, option_a, option_b, option_c, option_d, correct_answer, difficulty, category) VALUES
...
-- Category 5: Stadium & 12s (5 questions)
INSERT INTO trivia_questions (question_text, option_a, option_b, option_c, option_d, correct_answer, difficulty, category) VALUES
...
-- Category 6: Memorable Moments (6 questions)
INSERT INTO trivia_questions (question_text, option_a, option_b, option_c, option_d, correct_answer, difficulty, category) VALUES
...
-- Category 7: Players & Numbers (6 questions)
INSERT INTO trivia_questions (question_text, option_a, option_b, option_c, option_d, correct_answer, difficulty, category) VALUES
...
-- Category 8: Seahawks History (6 questions)
INSERT INTO trivia_questions (question_text, option_a, option_b, option_c, option_d, correct_answer, difficulty, category) VALUES
...
-- Tables: 10
-- Players: 6 (with detailed stats)
-- Questions: 51 (across 8 categories)
-- ============================================
