...
const DEMO_PLAYERS: Player[] = [
  ...
  {
    id: '2025-pats-antonio-gibson',
    name: 'Antonio Gibson',
    jersey_number: 21,
    position: 'Running Back',
    image_url: 'https://a.espncdn.com/i/headshots/nfl/players/full/4039359.png',
    stats: { 'Rush Yds': '445', 'Rush TD': '4', 'Rec Yds': '312' },
    bio: 'Patriots RB2 - 2025 Season',
    super_bowl_highlight: 'Explosive change-of-pace back',
    trivia: ['Memphis product', 'Former Washington Commander'],
    display_order: 103,
    is_active: true,
  },
  {
  ...
  {
    id: '2025-pats-kendrick-bourne',
    name: 'Kendrick Bourne',
    jersey_number: 84,
    position: 'Wide Receiver',
    image_url: 'https://a.espncdn.com/i/headshots/nfl/players/full/3042876.png',
    stats: { 'Rec': '45', 'Rec Yds': '612', 'Rec TD': '4' },
    bio: 'Patriots WR3 - 2025 Season',
    super_bowl_highlight: 'Veteran leader and YAC specialist',
    trivia: ['Eastern Washington product', 'Known for infectious energy'],
    display_order: 106,
    is_active: true,
  },
  {
  ...
  },
  {
    ...
    bio: 'Patriots EDGE - 2025 Pro Bowl',
    super_bowl_highlight: 'Veteran edge rusher leading defense',
    trivia: ['4-time Pro Bowl selection', 'Grand Valley State product'],
    display_order: 116,
    is_active: true,
  },
  {
  ...
  },
  {
    ...
    jersey_number: 48,
    position: 'Linebacker',
    image_url: 'https://a.espncdn.com/i/headshots/nfl/players/full/3895836.png',
    stats: { 'Tackles': '86', 'Sacks': '1.5', 'Pass Def': '4' },
    bio: 'Patriots LB - 2025 Season',
    super_bowl_highlight: 'Versatile linebacker excelling in coverage',
    trivia: ['Hawaii product', 'Originally drafted by Detroit'],
    display_order: 118,
    is_active: true,
  },
  {
  ...
  {
    id: '2025-pats-jonathan-jones',
    name: 'Jonathan Jones',
    jersey_number: 31,
    position: 'Cornerback',
    image_url: 'https://a.espncdn.com/i/headshots/nfl/players/full/2578265.png',
    stats: { 'Tackles': '62', 'INT': '2', 'Pass Def': '10' },
    bio: 'Patriots CB - 2025 Season',
    super_bowl_highlight: 'Veteran corner with playoff experience',
    trivia: ['Auburn product', 'Elite special teams player'],
    display_order: 120,
    is_active: true,
  },
  {
